...
import org.usfirst.frc.team747.robot.commands.AutonomousReader;
...
public class CenterRightSideSwitchSwerve extends CommandGroup {
    ...
    public  CenterRightSideSwitchSwerve() {
        ...
        addSequential(new AutonomousReader());
...
//        addParallel(new PIDDriveInchesCommandSlow(3, true));        
        ...
        addSequential(new PIDDriveInchesCommandSlow(16.75, false));
