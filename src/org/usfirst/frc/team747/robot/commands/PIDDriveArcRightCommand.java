...
public class PIDDriveArcRightCommand extends Command {
...
//    private final static int I_ZONE_IN_REVOLUTIONS = 50; //100;
    ...
    public PIDDriveArcRightCommand(double inches, boolean reverse) {
...
//        Robot.DRIVE_SUBSYSTEM.talonDriveRightPrimary.config_IntegralZone(slotIdx, I_ZONE_IN_REVOLUTIONS, timeoutMs);
        ...
        if (driveInches > 30) {
            ...
            Robot.DRIVE_SUBSYSTEM.talonDriveLeftPrimary.configMotionAcceleration(12250, timeoutMs); //test 5000
            ...
            Robot.DRIVE_SUBSYSTEM.talonDriveLeftPrimary.configMotionAcceleration(15000, timeoutMs);
            Robot.DRIVE_SUBSYSTEM.talonDriveRightPrimary.configMotionCruiseVelocity(7500, timeoutMs);
