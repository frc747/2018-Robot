 ...
 *
 */
public class PIDDriveRotateArcCommand extends PIDCommand {
...
private final static int TARGET_COUNT_ONE_SECOND = 50;
    ...
    private final static double STOP_THRESHOLD_DEGREES = 4.25;
    ...
    public PIDDriveRotateArcCommand(double degreesRotate) {
        super(0.06, 0.0, 0.12);
    ...
    protected void usePIDOutput(double output) {
        Robot.DRIVE_SUBSYSTEM.talonDriveLeftPrimary.set(ControlMode.PercentOutput, output);
        Robot.DRIVE_SUBSYSTEM.talonDriveRightPrimary.set(ControlMode.PercentOutput, -output);
    }
}
