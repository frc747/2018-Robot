 ...
 *
 */
public class PIDDriveRotateFromCenterCommand extends PIDCommand {
...
private final static int TARGET_COUNT_ONE_SECOND = 50;
    ...
    private final static double STOP_THRESHOLD_DEGREES = 4;
    ...
    public PIDDriveRotateFromCenterCommand(double degreesRotate) {
        super(0.06, 0.0, 0.12);
    ...
    protected void initialize() {
        ...
        getPIDController().setSetpoint(OI.table.getEntry("tx").getDouble(0));
    }
